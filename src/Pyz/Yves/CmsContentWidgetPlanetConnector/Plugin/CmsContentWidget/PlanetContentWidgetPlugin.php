...
use Pyz\Yves\CmsContentWidgetPlanetConnector\CmsContentWidgetPlanetConnectorFactory;
...
/**
 * @method CmsContentWidgetPlanetConnectorFactory getFactory()
 */
...
//        dd($this->getFactory()->getPlanetClient()->getPlanetByName($names[0]));
